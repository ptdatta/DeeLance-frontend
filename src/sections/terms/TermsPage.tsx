...
function TermsPage() {
  return (
    <div>
      <Helmet>
        <title>Terms & Condition | Deelance</title>
        <meta
          name="description"
        ...
        <div className="container-wrapper">
          <div className="space-y-6 mb-10">
            ...
            <p>
              ...
              this website or using any other services provided by
              https://deelance.com/ LLC.{" "}
            </p>
            <p>
              We, https://deelance.com/ .com LLC, reserve the right to review
              and amend any of these Terms of Service at our sole discretion.
              Upon doing so, we will update this page. Any changes to these
              Terms of Service will take effect immediately from the date of
              publication.{" "}
            </p>
            <p>These Terms of Service were last updated on 29 July 2022. </p>
            <h2 className=" text-2xl font-bold">Limitations of Use</h2>
            <p>
            ...
            <ol>
              ...
              <li>
                ...
                networks or any other service https://deelance.com/ LLC
                provides;
              </li>
              <li>
            ...
            <p>
              ...
              website are owned by or licensed to https://deelance.com/ LLC and
              are protected by applicable copyright and trademark law. We grant
            ...
            <p>
              ...
              https://deelance.com/ LLC makes no warranties, expressed or
            ...
            <p>
              ...
              website or the materials on this website, even if
              https://deelance.com/ LLC or an authorized representative has been
            ...
            <p>
              ...
              are for general information purposes only. https://deelance.com/
              LLC does not warrant or make any representations concerning the
            ...
            <p>
              {" "}
              https://deelance.com/ LLC has not reviewed all of the sites linked
              ...
              approval, or control by https://deelance.com/ .com LLC of the
            ...
            <h2 className=" text-2xl font-bold">Right to Terminate</h2>
            <p>
            ...
            <h2 className=" text-2xl font-bold">Severance</h2>
            <p>
            ...
            <p>
              ...
              with the laws of United Arab Emirates. You irrevocably submit to
