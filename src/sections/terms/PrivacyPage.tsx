...
function PrivacyPage() {
  return (
    <div>
      <Helmet>
        <title>Legal Center | DeeLance</title>
        <meta
          name="description"
          content="Discover DeeLance Blockchain's live testnet, testnet explorer, faucet, and comprehensive documentation. Built for freelancers,integrates blockchain transparency and traceability. Explore freelancing with DeeLance ."
        />
        <meta name="keywords" content="deelnace, Terms, dlance" />
      </Helmet>
      <PageLayout>
        <div className="container-wrapper">
          <div className="space-y-6 mb-10">
            ...
            <p>
              Your privacy is important to us. It is https://deelance.com/
              LLC&#39;s policy to respect your privacy and comply with any
              applicable law and regulation regarding any personal information
              we may collect about you, including across our website,{" "}
              <a href="https://deelance.com/">https://deelance.com/</a>, and
            ...
            <h1 className=" text-2xl font-bold">Device Data</h1>
            <p>
            ...
            <h1 className=" text-2xl font-bold">User-Generated Content</h1>
            <p>
              ...
              our users for the purpose of publication on our website or
            ...
            <ul>
              ...
              <li>
                to attribute any content (e.g. posts and comments) you submit
            ...
            <h1 className=" text-2xl font-bold">Children’s Privacy</h1>
            <p>
            ...
            <p>
              ...
              United Arab Emirates, or where we or our partners, affiliates, and
            ...
            <h1 className=" text-2xl font-bold">Use of Cookies</h1>
            <p>
            ...
            <h1 className=" text-2xl font-bold">Limits of Our Policy</h1>
            <p>
            ...
            <p>
              ...
              processors&rdquo;). We, https://deelance.com/ Technology Solutions
              LLC, located at the address provided in our Contact Us section,
              are a Data Controller and/or Processor with respect to the
            ...
            <h1 className=" text-2xl font-bold">Consent From You</h1>
            <p>
            ...
            <h1 className=" text-2xl font-bold">Our Legitimate Interests</h1>
            <p>
            ...
            <h1 className=" text-2xl font-bold">Compliance with Law</h1>
            <p>
            ...
            <p>
              ...
              personal information within 30 days of the deletion of your
            ...
            <h1 className=" text-2xl font-bold">Cookies and Pixels</h1>
            <p>
            ...
            <ul>
              ...
              <li>
                Employment and education data, such as data you provide when you
            ...
            <h1 className=" text-2xl font-bold">Right to Know and Delete</h1>
            <p>
            ...
            <h1 className=" text-2xl font-bold">Shine the Light</h1>
            <p>
